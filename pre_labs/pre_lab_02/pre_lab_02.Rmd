...
One question you might have is whether the lenders servicing these loan applications are located in Maryland or outside. We can add a column using mutate and populate it based on the state of the lender. Add a description of what this code does to your reference notebook.
...
Filter is a tidyverse verb that uses criteria you supply to return a subset of the original data. Here's how it works:
