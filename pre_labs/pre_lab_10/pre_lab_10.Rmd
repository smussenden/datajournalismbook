...
**Task** Then we'll write `md_counties` to a CSV in the data folder using write_csv:

```{r}
write_csv(md_counties, "data/md_counties.csv")
```

**Task** Go back to Datawrapper and click on "New Map". Choose "USA Counties (2018)" for the map base and upload the md_counties.csv file.
