...
A t-test can help us answer that question.  It can tell us where there's a statistically significant difference between the means of two groups. Have we found a real difference, or have we chanced upon a statistical abberation?  Let's see by calculating it for the average loan amount. 
...
```
We see our two means, for Trump and Clinton, the same as we calcluated above. The t-value is approximately 1, the p-value here is .2295, both of which should which should give us pause that we've identified something meaningful. [More on t-tests here](https://conjointly.com/kb/statistical-student-t-test/)
