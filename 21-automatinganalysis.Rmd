...
We need to clean this dataframe a bit more, though, to remove those colons from `description` and to make the other columns into numbers (and remove the commas):
