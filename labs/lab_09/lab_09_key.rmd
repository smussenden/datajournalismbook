...
**A1.** April 28 saw the most, with 2381. 
```{r}
...
# Group by date and count total loans.  Filter to keep only loans in April 2020
...
ppp_wv_loans %>%
  ...
  theme(
    ...
    title="A spike in WV PPP loan approvals at end of April",
    x = "Date",
    y = "Total Loans",
    caption = "source: SBA PPP Loan Data"
