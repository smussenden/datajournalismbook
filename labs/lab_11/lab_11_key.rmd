...
```{r}
ppp_wv_loans <- read_rds("data/lab_11.rds")
...
Use the magma color palette, and shade on a "log" scale. Also produce a table that shows the total amount of loans per 100,000 population, ranked from highest to lowest, along with the total amount of loans and the total number of loans. 

Then answer these questions:

* Based on the map, what region of the state appears to have gotten more loans in this industry? What spatial pattern do you notice in the data?
...
**A1.** It's pretty similar.  There's a big cluster of mines in the southern part of the state, and most of them are in the southwest-northeast seam we identified previously.
