...
* Sit-down restaurants were particularly vulnerable during the pandemic, especially the early months, as public health measures in many states limited or prevent in-restaurant dining. The economic hit may have driven restaurant owners to seek help with more urgency than in other industries. * The position of restaurants at the top may just be an artifact of using fine-grained NAICS data.
