...
Barber loans per state?

**Q1.** Which state has the most PPP applications per capita (per 100k) from barber shops?

You MUST do the following things when answering this question:
* Use the PPP loan data, which is in the data folder and is called lab_10.rds.
* Find the NAICS code that corresponds to barber shops from [this site](https://www.census.gov/naics/).
